    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(data.cart_items, function(index, item) {
                ...
                cartItemHTML += '<input type="number" name="quantity" value="' + item.quantity + '" min="1" class="qty-control__number qty-control__number-1 border-0 text-center" data-product-id="' + item.id + '">';
...
$('.js-add-cart-cust').click(function(e) {
    ...
    var quantity = $('#quick-view-quantity').val() ?? 1;
